...
//for sending the value of a rotary encoder over the network. The messages are published
//on a specific topic within the MQTT broker and can be viewed by any connected MQTT client.
...
const char outTopic[] = "/MQTT-01/";  //The outgoing topic
